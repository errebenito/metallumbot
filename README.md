...
## Usage
The bot is available at [t.me/em_band_bot](https://t.me/em_band_bot). It supports the following commands:

- `/band`: returns a link to a random band page on [Metal Archives](https://www.metal-archives.com/).
- `/upcoming`: returns a link to a random upcoming album on [Metal Archives](https://www.metal-archives.com/), based on the information on the [upcoming albums](https://www.metal-archives.com/release/upcoming) page.
...
### Documentation
The `docs/adr` folder contains the architecture decision records for the bot.
